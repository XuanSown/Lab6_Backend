        ...
        <div class="row g-4">
            <form @submit.prevent="submitForm" class="col-sm-4">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" min="0" max="10" class="form-control" v-model="student.score" id="score"
                        required />
                </div>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <tr v-for="(stu, index) in students" :key="index">
                            ...
                            <td>{{ stu.score }}</td>
                            <td>{{ stu.dob }}</td>
                            <td><button class="btn btn-primary" @click="editStudent(index)">Sửa</button></td>
...
import { ref } from 'vue';
const students = ref([
    { name: 'Nguyễn Văn A', score: 8, dob: '2000-01-01' },
    { name: 'Trần Thị B', score: 9, dob: '1999-05-15' },
]);
